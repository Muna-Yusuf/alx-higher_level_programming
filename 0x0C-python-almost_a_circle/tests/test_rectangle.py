...
class TestRectangle(unittest.TestCase):
    ...
    def test_class(self):
        """Testing Rectangle class type."""
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_inheritance(self):
        """Testing if Rectangle inheriting Base."""
...
given"
    ...
    def test_id_inherited(self):
        """Testing if id is inheriting from Base"""
    ...
    def test_validate_valuenegative_gt(self):
        """Testing property validation."""
        r = Rectangle(1, 2)
    ...
    def test_validate_valuenegative_ge(self):
        """Testing property validation."""
        r = Rectangle(1, 2)
        attributes = ["x", "y"]
        for attribute in attributes:
    ...
    def test_property_rangezero(self):
        """Testing property set - get."""
        r = Rectangle(1, 2)
        r.x = 0
        r.y = 0
