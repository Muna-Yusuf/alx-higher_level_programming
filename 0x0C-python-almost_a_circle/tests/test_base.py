...
class TestBase(unittest.TestCase):
    ...
    def test_nb_objects_private(self):
        """Testing if nb_objects is private class attribute."""
        self.assertTrue(hasattr(Base, "_Base__nb_objects"))

    def test_B_nb_objects_initialized(self):
        """Testing if nb_objects initializes to zero."""
        self.assertEqual(getattr(Base, "_Base__nb_objects"), 0)

    def test_C_instantiation(self):
        """Testing Base() instantiation."""
        b = Base()
...
were given"
    ...
    def test_consecutive_ids(self):
        """Testing consecutive ids."""
        b1 = Base()
        b2 = Base()
        self.assertEqual(b1.id + 1, b2.id)

    def test_id_synced(self):
        """Testing sync between class and instance id."""
        b = Base()
    ...
    def test_id_keyword(self):
        """Testing id passed as keyword arg."""
        i = 421
        b = Base(id=i)
        self.assertEqual(b.id, i)
